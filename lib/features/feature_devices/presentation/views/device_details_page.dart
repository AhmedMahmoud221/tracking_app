    ...
    return BlocBuilder<DevicesCubit, DevicesState>(
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          body: Column(
            key: ValueKey(
              '${currentDevice.id}_${currentDevice.brand}_${currentDevice.image}',
            ),
            children: [
      ...
      child: GridView(
        ...
        children: [
          ...
          _infoCard(
            ...
            currentDevice.status.localized(context),
            currentDevice.status == 'active' ? Colors.green : Colors.red,
            isDark,
          ),
          _infoCard(
            Icons.speed,
            AppLocalizations.of(context)!.speed,
            '${currentDevice.lastRecord?.speed ?? '-'} km/h',
            Colors.orange,
            isDark,
          ),
        ],
  ...
  void _showDeleteDialog(BuildContext context, DeviceEntity currentDevice) {
    ...
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: Text(
          AppLocalizations.of(context)!.areyousureyouwanttodeletethisdevice,
        ),
        actions: [
          TextButton(
